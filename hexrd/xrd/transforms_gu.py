...
from numbapro import float64, jit, autojiti, vectorize, guvectorize
...
@guvectorize(['(float64[:,:], float64[:,:], float64[:,:], float64[:,:], float64[:,:], float64[:,:], float64[:,:]'], '(t,n),(t,t),(t,t),(t,t),(t,o),(t,o),(t,o)->(t,m)')
